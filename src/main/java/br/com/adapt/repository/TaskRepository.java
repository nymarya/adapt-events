...
public interface TaskRepository extends JpaRepository<Task, Integer> {
	...
	@Query("select t.startDate,t.endDate,t.title,t.day,t.id from Task t left join Scheduler s on t.scheduler=s.id left join User u on u.id=s.user where u.email = ?1")
